    ...
    def test_multiple_universe_changes_in_sequence(self, universe_changes):
        ...
        check_points = [
            ...
            (
                200,
                True,
            ),  # After first period (100 rows, 150 days since first) - still eligible
            (
                400,
                True,
            ),  # In second period (100 + 101 rows, lots of history) - eligible
        ...
        for day_idx, expected in check_points:
            ...
            assert (
                eligible["E_MultipleChanges"] == expected
