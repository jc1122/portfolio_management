...
class TestComputePitEligibility:
    ...
    def test_late_starter_not_eligible_early(
        self, sample_returns_with_late_starter
    ):
    ...
    def test_no_assets_eligible_at_start(
        self, sample_returns_with_late_starter
    ):
    ...
    def test_eligibility_respects_min_rows(
        self, sample_returns_with_gaps
    ):
    ...
    def test_eligibility_before_any_data(
        self, sample_returns_with_late_starter
    ):
...
class TestDetectDelistings:
    ...
    def test_detect_delisted_asset(
        self, sample_returns_with_delisting
    ):
    ...
    def test_no_delistings_when_all_active(
        self, sample_returns_with_late_starter
    ):
    ...
    def test_delisting_last_date_correct(
        self, sample_returns_with_delisting
    ):
...
class TestGetAssetHistoryStats:
    ...
    def test_stats_for_full_history_assets(
        self, sample_returns_with_late_starter
    ):
    ...
    def test_stats_for_late_starter(
        self, sample_returns_with_late_starter
    ):
    ...
    def test_stats_for_delisted_asset(
        self, sample_returns_with_delisting
    ):
